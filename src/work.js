...
export default memo(function Work({ work }) {
  return (
    <div className="Work" style={{ marginBottom: '50px' }}>
      <div className="Work-parts" data-work-id={work.id} style={{ height: uiSettings.partHeight, display: 'grid', gridTemplateColumns: work.parts.map(part => `${part.length}fr`).join(' ') }}>
