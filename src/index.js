...
import FileSystemAccessDocumentManager from './document-management/file-system-access-document-manager';

const defaultOptions = {
  partHeight: 50,
  workHorizontalMargin: 50,
  workVerticalMargin: 50,
  documentManager: new FileSystemAccessDocumentManager()
};
